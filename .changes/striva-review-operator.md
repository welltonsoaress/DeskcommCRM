...
impacto: nada_mudou
secao: corrigido
titulo: Revisão da marca, sugestões, casos e execução do Operador
---

Login e cadastro passam a usar o nome da instalação salvo no banco, como o logo e as cores. Sugestões concluídas permitem gerar uma nova resposta pelo controle compacto. Alterações nos casos atualizam também a lista em tempo real.
