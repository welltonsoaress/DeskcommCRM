...
const THEME_INIT_SCRIPT = `(function(){try{var s=localStorage.getItem('striva-theme')||localStorage.getItem('deskcomm-theme');if(s&&!localStorage.getItem('striva-theme'))localStorage.setItem('striva-theme',s);var d=window.matchMedia('(prefers-color-scheme: dark)').matches;var r=(s==='dark'||s==='light')?s:((s==='system'||!s)&&d?'dark':'light');document.documentElement.setAttribute('data-theme',r);}catch(e){document.documentElement.setAttribute('data-theme','light');}})();`;
