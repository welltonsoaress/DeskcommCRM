...
export const DICIONARIO: Traducoes = {
  ...
  "Número comercial": { es: "Número comercial" },
  "Usuário gestor da empresa": { es: "Usuario responsable de la empresa" },
  ...
  "Enviar resumo diário": { es: "Enviar resumen diario" },
  ...
  "Negócios críticos do Radar": { es: "Oportunidades críticas del Radar" },
  "Tarefas vencidas": { es: "Tareas vencidas" },
  "Máximo de alertas por dia": { es: "Máximo de alertas por día" },
  ...
  "solicitar agendamento": { es: "solicitar cita" },
